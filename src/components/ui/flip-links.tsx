...
export const Component = () => {
  return (
    <section className="grid place-content-center gap-2 bg-background w-full h-screen text-black">
      ...
      <FlipLink href="https://instagram.com/_._mades_._">Instagram</FlipLink>
    </section>
  );
};
...
export const FlipLink = ({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`flip-link-item group text-primary relative block overflow-hidden whitespace-nowrap text-4xl font-black uppercase sm:text-7xl md:text-8xl lg:text-9xl ${className}`}
      style={{
        lineHeight: 0.75,
      }}
    >
      <div className="flex flip-link-front">
      ...
      <div className="absolute inset-0 flex flip-link-back">
        {children.split("").map((letter, i) => (
          <span
            key={i}
